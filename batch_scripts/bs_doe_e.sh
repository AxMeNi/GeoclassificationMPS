...
#SBATCH --output=log/mps_clf_task_e_%a.txt
#SBATCH --array=1-280
...
IDX=$((SLURM_ARRAY_TASK_ID - 1 + 1120)) # Index of the task, starting from 0
...
OUTPUT_DIR="./output_mps_clf_${IDX+1}_${AUX_VARS}_PCT_${TI_PCT_AREA}_NSHP_${NUM_SHAPE}_SEED_${SEED}"
